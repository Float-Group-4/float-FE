...
const AddButtonMultiplePurpose = (props: AddButtonMultiplePurposeButtonProps) => {
  ...
  return (
    <>
      ...
      {openMiddlePage && (
        <CreateProjectMiddlePage
          isOpen={openMiddlePage}
          setIsOpen={setOpenMiddlePage}
          handleOpenNewProjectTemplate={(t: any) => {
            setTemplate(t);
            setOpenNewProjectTemplate(true);
            setOpenMiddlePage(false);
          }}
      ...
      {openAddPerson && <AddPeopleModal isOpen={openAddPerson} setIsOpen={setOpenAddPerson} />}
    </>
  );
};
