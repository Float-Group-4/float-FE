export default () => {
  ...
  return (
    <footer style={{ paddingTop: '2.5rem', borderTop: '1px solid lightgrey' }}>
      <div
        style={{
          maxWidth: '90rem',
          marginLeft: 'auto',
      ...
      >
        ...
        >
          {footerNavs.map((item, idx) => (
            <ul key={idx} style={{ marginBottom: '1.5rem' }}>
              <h4
                style={{
                  fontSize: '1rem',
                  fontWeight: 'bold',
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginTop: '1.5rem' }}>
            <a href='javascript:void()'>
              <svg
                style={{ width: '1.5rem', height: '1.5rem', transition: 'color 0.3s ease' }}
                fill='currentColor'
                viewBox='0 0 48 48'
              >
                <g clipPath='url(#a)'>
